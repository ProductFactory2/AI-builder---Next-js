            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogDescription className="text-lg text-gray-300">
                  By selecting <span className="text-orange-500">&ldquo;Confirm&rdquo;</span> you will choose this template, and the other two templates will be permanently deleted and cannot be recovered.
                </AlertDialogDescription>
