...
import DigitalImage from '@/public/landing-page/assets/DigitalImage.png'
import DotUpper from '@/public/landing-page/assets/DotUpper.png' 
import DotLower from '@/public/landing-page/assets/DotLower.png' 
            ...
            <div className='w-full md:w-1/2 relative mx-auto'>
                <div className='relative w-fit mx-auto'>
                    <Image 
                        ...
                        width={634}
                        height={300}
                        className='hidden 2xl:block mx-auto relative z-10'
                    />
                    ...
                    <Image 
                        ...
                        width={500}
                        height={350}
                        className='hidden lg:hidden xl:block 2xl:hidden mx-auto relative z-10'
                    />
                    ...
                    <Image 
                        ...
                        width={500}
                        height={300}
                        className='hidden md:hidden lg:block xl:hidden mx-auto relative z-10 ml-10 mr-5 pl-10'
                    />
                    <Image 
                        src={DigitalImage}
                        alt="Digital Creation"
                        width={500}
                        height={300}
                        className='hidden md:block lg:hidden mx-auto relative z-10 flex justify-center items-center'
                    />
                    ...
                    <Image 
                        ...
                        width={500}
                        height={300}
                        className='sm:block md:hidden mx-auto relative z-10 flex justify-center items-center px-10'
                    />
